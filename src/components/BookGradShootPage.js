    ...
    return (
        <div className="bookGradShootPage">
            ...
            <div className="clientInputFieldsContainer">
                ...
                <div className="clientInputFields">
                    <FormControl fullWidth>
                        <TextField id="clientFirstName" label="First Name" variant="standard" required="true"/>
                        <TextField id="clientLastName" label="Last Name" variant="standard" required="true"/>
                        <TextField id="clientPronouns" label="Pronouns" variant="standard" required="true"/>
                    </FormControl>
                    <FormControl fullWidth>
                        <div className="contactContainer">
                            <div className="contactRadioButtonsContainer">
                            <FormLabel id="demo-radio-buttons-group-label">Preferred Contact Method</FormLabel>
                            <RadioGroup
                                row="true"
                            ...
                            {contactMethod === "phone" &&
                            <TextField id="contactInput" label="Phone" variant="standard" required="true"/> }
                            {contactMethod === "email" &&
                            <TextField id="contactInput" label="Email" variant="standard" required="true"/> 
                            }
                        </div>
                    </FormControl>
            ...
            <div className="bookShootPage__navigationButtons" >
                <Button className="bookShootPage__homeButton" variant="outlined">Back</Button>
                <Button className="bookShootPage__homeButton" variant="contained">Next</Button>
            </div>
        </div>
    );
}
